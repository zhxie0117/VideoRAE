# Train discrete VideoRAE (V-JEPA 2 + Multi-Codebook SimVQ) on an 8-GPU machine with DDP.
# Pass model.args.vjepa2_encoder_ckpt to your local V-JEPA 2 encoder weights.

python3 \
    train.py --cfg cfgs/vqrae_vjepa.yaml \
    --manualSeed 66667 --tag default \
    --csv_file ucf101_train.csv+kinetics_dataset.csv --out_path save/vjepa_varae \
    ...
    vis_epoch 5 eval_epoch 5  max_epoch 150 latest_interval 1 save_best true 
